...
<div class="container-fluid page-header py-5" style="background: url('https://images.unsplash.com/photo-1524504388940-b1c1722653e1?ixlib=rb-4.0.3&auto=format&fit=crop&w=1400&q=80') center/cover no-repeat;">
    <h1 class="text-center text-white display-6">Chekout Layanan dan Item</h1>
                    ...
                    <div class="row g-5">
                        <div class="col-md-12 col-lg-6 col-xl-6">
                            <div class="row">
                              ...
                              {{-- <div class="col-md-12 col-lg-4">
                                <div class="form-item w-100">
                                    <label class="form-label my-3">Pilih Capster <sup>*</sup></label>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="py-5">{{ $item['item_name'] }}</td>
                                                <td class="py-5">Rp{{ number_format($item['price'], 0, ',', '.') }},00</td>
                                                <td class="py-5">{{ $item['qty'] }}</td>
                                                <td class="py-5">Rp{{ number_format($lineTotal, 0, ',', '.') }},00</td>
                                            </tr>
                                        ...
                                        <div class="py-4 mb-4 d-flex justify-content-between">
                                            ...
                                            <div class="mb-0 pe-4 mb-3 pe-5">
                                                <div class="form-check">
                                                    <input type="radio"  name="payment_method"  class="form-check-input bg-primary border-0" id="qris" name="payment" value="qris">
                                                    <label class="form-check-label" for="qris">QRIS</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="radio"   name="payment_method" class="form-check-input bg-primary border-0" id="cash" name="payment" value="tunai">
