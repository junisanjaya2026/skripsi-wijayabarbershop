...
<head>
  ...
  <title>Wijaya Barber — Register</title>
...
<body class="flex items-stretch min-h-screen">
  ...
  <div class="flex flex-1 items-center justify-center px-6 py-12 relative" style="background: var(--dark);">
    ...
    <div class="lg:hidden absolute top-8 left-1/2 -translate-x-1/2 flex items-center gap-2">
      ...
      <span class="display-font gold-text tracking-widest text-lg">Wijaya Barbershop</span>
    </div>
    ...
    <div class="w-full max-w-sm relative z-10">
      ...
      <div class="animate-fade-up delay-1">
        <p class="text-xs tracking-[0.3em] uppercase mb-2" style="color: var(--gold);">Buat Akun Baru</p>
        <h2 class="display-font text-4xl" style="color: var(--cream);">REGISTER<br/>AKUN</h2>
      </div>
    ...
    <form method="POST"
      ...
      <div class="animate-fade-up delay-2">
        ...
        <input
          ...
          class="input-field w-full px-4 py-3.5 rounded-sm text-sm"
        >
      ...
      <p class="text-center text-xs mt-8 animate-fade-up delay-5" style="color: var(--muted);">
        Sudah punya akun?
        <a href="/login" class="ml-1 font-medium transition-colors hover:text-green-700" style="color: var(--gold);">Masuk Sekarang</a>
      </p>
