            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                      <div class="logo me-2">
                       <a href="{{ route('admin.dashboard') }}" class="sidebar-logo-text">WBadmin
</a>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">
                            ...
                            <li class="sidebar-item {{ request()->routeIs('admin.item.*') ? 'active' : '' }}">
                            ...
                            {{-- <li class="sidebar-item {{ request()->routeIs('admin.capster.*') ? 'active' : '' }}">
                            ...
                            <li class="sidebar-item {{ request()->routeIs('admin.role.*') ? 'active' : '' }}">
